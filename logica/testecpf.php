...
if(isset($_POST['btvalidar']))
  ...
  if($cpf_enviado == true)
   ...
   echo"<script language='javascript' type='text/javascript'>alert('CPF Inválido !');window.location.href='testecpf.php';</script>";
  }
?>
...
<body>
<form action="testecpf.php" method="post" name="cpf" id="cpf">
  CPF: 
  <label>
