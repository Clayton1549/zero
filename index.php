...
<html>
			...
			<a class="navbar-brand"   href="index.php"><img src="images/logo_b.jpg" alt="clayton"></a>
			   ...
			   <button class="navbar-toggler" data-toggle="collapse" data-target="#menu" >
				 ...
				 <ul class="navbar-nav ml-auto ">
			        <li class="nav-item ">
					  <a class="nav-link active" href="templates/login_h.php"><span class=""></span>Login </a>
					<li class="nav-item">
					  <a class="nav-link" href="templates/cadastro.php"><span class=""></span> Cadastro</a>
					 </li>
				</ul>  
             </div>
		</nav>
 ...
 <div class="row">
  ...
  <div class="container text-justify col-3">
