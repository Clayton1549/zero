...
include("../bd/conexao.php");
  ...
  $resultado = mysqli_query($conexao,$sql);
   ...
   echo "<h2 class='text-center  text-info' >Fotos ilustrativas enviados por    Internautas</h2>";
		...
		<?php 
		 ...
		 echo '</a>';
			  ...
			  echo   '<p class="card-text text-danger">Todas as fotos enviadas por nossos internautas são meramente ilistrativas .</p>';
			  echo '<p class="text-success"> R$ 70.00 </p>';
              

			  echo '<a href="pedidos.php?id='.$row['codigo'].
		'"   class="btn btn-primary ">Comprar '.$row['codigo'].' </a>';  
